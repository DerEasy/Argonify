...
public class PasswordDBHelper extends SQLiteOpenHelper {
    ...
    public static final int AMOUNT_OF_SELECTABLE_COLUMNS = 5;
    ...
    public static final String[] selectableColumns = new String[AMOUNT_OF_SELECTABLE_COLUMNS];
    ...
    public PasswordDBHelper(@Nullable Context context) {
        ...
        selectableColumns[0] = COLUMN_NAME;
        selectableColumns[1] = COLUMN_PASSWORD;
        selectableColumns[2] = COLUMN_EMAIL;
        selectableColumns[3] = COLUMN_USERNAME;
        selectableColumns[4] = COLUMN_NOTES;
    }
